...
function Levi() {
  let html = `
    <a-scene embedded renderer="colorManagement: true;" hiderings="true">
      ...
      <a-entity look-controls="enabled: false" target-indicator="target: #theEntity;" camera position rotation orbit-controls="target: 0 0 -5; minDistance: 1; maxDistance: 5; initialPosition: 0.5 0.5 -3.5; screenSpacePanning: true"></a-entity>
